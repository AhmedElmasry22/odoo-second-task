...
class LetterReportWizardDifferentPages(models.TransientModel):
    _name="letter.guarantee.wizard.diff"
    _description="Search for Letters With Wizard Diff"
    ...
    def action_print_report(self):
        ...
        return self.env.ref('letters_guarantee.letter_report_wizard_act_different').report_action(self,data=data)
